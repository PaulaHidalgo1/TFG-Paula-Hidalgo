...
<body>
    ...
    <h2 class="titulo">Encuentra trabajadores cualificados cerca de ti en un solo lugar. <br> Publica tu solicitud, compara presupuestos y elige al profesional perfecto.<br> ¡Regístrate hoy mismo y facilita tu vida!</h2>
