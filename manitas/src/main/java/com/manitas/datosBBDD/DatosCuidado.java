...
@WebServlet("/cuidado")
public class DatosCuidado extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String sql = "SELECT username, ubicacion, tarifa FROM usuarios WHERE servicio = 'Cuidado de niños'";
            ...
            request.getRequestDispatcher("cuidado.jsp").forward(request, response);
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
