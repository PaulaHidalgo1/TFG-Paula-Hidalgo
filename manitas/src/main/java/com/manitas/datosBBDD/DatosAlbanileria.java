...
@WebServlet("/albanileria")
public class DatosAlbanileria extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String sql = "SELECT username, ubicacion, tarifa FROM usuarios WHERE servicio = 'Albañilería'";
            ...
            request.getRequestDispatcher("albanileria.jsp").forward(request, response);
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
