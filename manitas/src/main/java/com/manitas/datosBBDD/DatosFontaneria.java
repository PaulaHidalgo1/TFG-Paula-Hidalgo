...
@WebServlet("/fontaneria")
public class DatosFontaneria extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String sql = "SELECT username, ubicacion, tarifa FROM usuarios WHERE servicio = 'Fontanería'";
            ...
            request.getRequestDispatcher("fontaneria.jsp").forward(request, response);
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
