...
@WebServlet("/carpinteria")
public class DatosCarpinteria extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String sql = "SELECT username, ubicacion, tarifa FROM usuarios WHERE servicio = 'Carpintería'";
            ...
            request.getRequestDispatcher("carpinteria.jsp").forward(request, response);
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
