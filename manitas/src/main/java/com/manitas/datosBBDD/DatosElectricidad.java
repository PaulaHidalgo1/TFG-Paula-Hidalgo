...
@WebServlet("/electricidad")
public class DatosElectricidad extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String sql = "SELECT username, ubicacion, tarifa FROM usuarios WHERE servicio = 'Electricidad'";
            ...
            request.getRequestDispatcher("electricidad.jsp").forward(request, response);
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
