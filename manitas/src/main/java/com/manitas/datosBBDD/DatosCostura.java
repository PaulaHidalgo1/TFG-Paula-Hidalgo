...
@WebServlet("/costura")
public class DatosCostura extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String sql = "SELECT username, ubicacion, tarifa FROM usuarios WHERE servicio = 'Costura'";
            ...
            request.getRequestDispatcher("costura.jsp").forward(request, response);
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
